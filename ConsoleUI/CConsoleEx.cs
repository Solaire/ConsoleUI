...
namespace ConsoleUI
{
    ...
    public static class CConsoleEx
    {
        ...
        public static void DrawHorizontalLine(int x, int y, int length, ConsoleColor colourBG, ConsoleColor colourFG)
        {
            Console.BackgroundColor = colourBG;
        ...
        /// <param name="colourBG">Background colour</param>
        /// <param name="colourFG">Foregound colour</param>
        public static void DrawVerticalLine(int x, int y, int length, ConsoleColor colourBG, ConsoleColor colourFG)
        {
            Console.BackgroundColor = colourBG;
            Console.ForegroundColor = colourFG;
